...
> python verify_levels.py      # 验证 4 个关卡均可通关
> ```
...
| 关卡 | 名称 | 规模 | 失误上限 | 设计要点 |
| --- | --- | --- | --- | --- |
| 1 | 初识箭阵 | 5×5 / 2 箭 | 3 | 两支互不阻挡的箭头，熟悉基本操作 |
| 2 | 层层递进 | 5×5 / 3 箭 | 4 | 纵向链式阻挡，必须自下而上射出 |
| 3 | 纵横交错 | 6×6 / 6 箭 | 5 | 横向链与纵向箭头相互牵制 |
| 4 | 连环锁阵 | 6×6 / 8 箭 | 6 | 横链门控纵链，需整体规划顺序 |
